...
import {
  Markdown,
  MarkdownHeading,
  MarkdownImageUploadNode,
  MarkdownParagraph,
} from "@/components/tiptap-extension/markdown-extension"
...
/** The simple-editor template's extension set, serialized to markdown. */
export function createSimpleEditorExtensions({
  ...
  return [
    ...
    MarkdownImageUploadNode.configure({
      accept: "image/*",
...
/**
 * The simple-editor template's toolbar. It acts on whichever editor the
 * surrounding EditorContext provides, so one toolbar can serve many editors.
 */
